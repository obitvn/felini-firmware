...
struct battery_platform_data {
	...
	int ntc_degree_from;
	uint32_t ntc_factor;
	uint32_t max_input_current;
	uint32_t max_chrg_current;
	uint32_t max_chrg_voltage;
	uint32_t lp_input_current;
	uint32_t lp_soc_min;
	uint32_t lp_soc_max;
	uint32_t pwroff_vol;
	uint32_t monitor_sec;
	uint32_t zero_algorithm_vol;
	uint32_t zero_reserve_dsoc;
	uint32_t bat_res;
	uint32_t design_capacity;
	uint32_t design_qmax;
	uint32_t sleep_enter_current;
	uint32_t sleep_exit_current;
	uint32_t sleep_filter_current;
	uint32_t power_dc2otg;
	uint32_t max_soc_offset;
	uint32_t bat_mode;
	uint32_t fb_temp;
	uint32_t energy_mode;
	uint32_t cccv_hour;
	uint32_t dc_det_adc;
	int dc_det_pin;
	u8  dc_det_level;
...
static const uint16_t uint16_tD_BACK_TEMP[] = {
	85, 95, 105, 115
};

static const uint16_t CHRG_VOL_SEL[] = {
...
static const uint16_t CHRG_CUR_SEL[] = {
	1000, 1200, 1400, 1600, 1800, 2000, 2250, 2400
};

static const uint16_t CHRG_CUR_INPUT[] = {
