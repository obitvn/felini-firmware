...
void IMUSensorView::Create(lv_obj_t *root)
{
    ...
    lv_label_set_text(ui_LabelAppTag, "IMUSensor");
    ...
    lv_obj_set_x(ui_MapPos, -112);
    lv_obj_set_y(ui_MapPos, 69);
