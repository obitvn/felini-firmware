...
void PowerSupplyView::Create(lv_obj_t *root)
{
    ...
    lv_obj_set_style_text_font(ui_VoltMeasure, ResourcePool::GetFont("alibabasans_regular_48"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_AmpMeasure, ResourcePool::GetFont("alibabasans_regular_48"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_PowerConsumer, ResourcePool::GetFont("alibabasans_regular_48"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_VoltSet, ResourcePool::GetFont("alibabasans_regular_26"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_AmpSet, ResourcePool::GetFont("alibabasans_regular_26"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_PDmode, ResourcePool::GetFont("alibabasans_regular_26"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_temp, ResourcePool::GetFont("alibabasans_regular_26"), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_time, ResourcePool::GetFont("alibabasans_regular_26"), LV_PART_MAIN | LV_STATE_DEFAULT);
